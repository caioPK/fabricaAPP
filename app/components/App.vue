        ...
        <TabView android:tabBackgroundColor="#53ba82"
            ...
            <TabViewItem title="SETOR" >
                <ScrollView orientation="vertical">
                    <GridLayout columns="* , *" rows="150, 150, 150" backgroundColor="lightgray" class="container-setor" >
                        <Button  v-for="setor in setores" :text="setor.nome"  :row="setor.x"  :col="setor.y" class="botao-setor" @tap="onButtonTap(setor.cat)" />
                    </GridLayout>
                </ScrollView>
            </TabViewItem>
